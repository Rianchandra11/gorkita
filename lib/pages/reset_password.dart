...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Icon(Icons.developer_mode, size: 18, color: Colors.blue),
                            SizedBox(width: 8),
                            Text(
                              'Mode Development',
                              style: TextStyle(
                        ...
                        const SizedBox(height: 8),
                        OutlinedButton(
                          onPressed: _showDebugCodeDialog,
                          style: OutlinedButton.styleFrom(
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                          ),
                          child: const Text('🛠️ Gunakan Kode Contoh (123456)'),
                        ),
                      ],
                    ),
                  ),
  ...
  void _showDebugCodeDialog() {
    ...
    _showMessage(' Kode contoh 123456 telah dimasukkan', Colors.blue);
  }
