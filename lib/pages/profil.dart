...
Widget build(BuildContext context) {
                ...
                SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _infoItem(Icons.email, 'Email', email ?? '-', themeProvider),
                          _infoItem(Icons.phone, 'Telepon', nohp ?? '-', themeProvider),
                          _infoItem(Icons.emoji_events, 'Level', levelSkill ?? '-', themeProvider),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _aktivitas('GOR Bung Tomo', '07:00 - 09:00 • Lapangan A', 'Main Bareng', themeProvider),
                          _aktivitas('Sparring dengan Rian', '20:00 - 22:00 • GOR Merdeka', 'Sparring', themeProvider),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              Icon(Icons.contrast, color: Color(0xFF4CAF50), size: 20),
                              SizedBox(width: 12),
                              Expanded(
                                child: Text(
  ...
  Widget _infoItem(IconData icon, String title, String value, ThemeProvider themeProvider) {
    return Padding(
  ...
  Widget _aktivitas(String title, String time, String type, ThemeProvider themeProvider) {
    Color typeColor = type == 'Main Bareng' ? Color(0xFFFF9800) : Color(0xFF2196F3);
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: themeProvider.isDarkMode ? Colors.white : Colors.black87)),
                SizedBox(height: 2),
  ...
  Widget _BuildItem(String title, IconData icon, VoidCallback onTap, ThemeProvider themeProvider) {
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 12),
            Expanded(
              child: Text(title, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: themeProvider.isDarkMode ? Colors.white : Colors.black87)),
            ),
